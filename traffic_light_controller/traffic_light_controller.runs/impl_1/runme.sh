...
HD_PWD='C:/Users/Chick/Vivado_Builds/traffic_light_controller/traffic_light_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_control_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_control_tb.tcl -notrace
