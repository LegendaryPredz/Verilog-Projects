...
HD_PWD='C:/Users/Chick/Vivado_Builds/traffic_light_controller/traffic_light_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_control_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_control_tb.tcl
