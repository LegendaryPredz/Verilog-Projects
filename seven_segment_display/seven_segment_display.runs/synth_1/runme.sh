...
HD_PWD='C:/Users/Chick/Vivado_Builds/seven_segment_display/seven_segment_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ssd_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ssd_tb.tcl
