...
HD_PWD='C:/Users/Chick/Vivado Builds/FPGAPCIE/FPGAPCIE.runs/bd_d92b_auto_ss_slid_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_d92b_auto_ss_slid_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_d92b_auto_ss_slid_1.tcl
