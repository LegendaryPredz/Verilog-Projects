...
HD_PWD='C:/Users/Chick/Vivado Builds/FPGAPCIE/FPGAPCIE.runs/bd_d92b_m06_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_d92b_m06_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_d92b_m06_regslice_0.tcl
