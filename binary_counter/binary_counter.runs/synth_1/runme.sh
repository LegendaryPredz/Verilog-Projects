...
HD_PWD='C:/Users/Chick/Vivado_Builds/binary_counter/binary_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcount_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcount_tb.tcl
